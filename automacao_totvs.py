...
try:    
    ...
    for _ in range(2):    
        ...
        if encontrar_img:
            ...
            distancia_Img_x = 0  # Ajuste para a posição de clique correta se for necessario.
            distancia_Img_y = 0
            pyautogui.moveTo(encontrar_img.x + distancia_Img_x, encontrar_img.y + distancia_Img_y)
            pyautogui.click()  # Adicione o clique após mover o mouse
            print("Imagem encontrada e download realizado.")

             # Passo 3 - Preenchimento de campos e encaminhamento do arquivo TOTVS
        else:
